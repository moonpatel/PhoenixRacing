    ...
    <div className='crew-members'>
      ...
      <div className='team'>
        ...
        <div className='technical'>
          ...
          {crewmembers_tech.map((member, index) => (
          <CrewCard
            key={index} 
            name={member.name}
            image={member.image}
        ...
        <div className='technical'>
          ...
          <div className='technical-crew'>
          {crewmembers_manage.map((member, index) => (
          <CrewCard
        ...
        <div className='technical'>
          ...
          <div className='technical-crew'>
          {crewmembers_electrical.map((member, index) => (
          <CrewCard
            key={index} // Ensure a unique key for each item
            name={member.name}
            image={member.image}
        ...
        <div className='technical'>
          ...
          <div className='technical-crew'>
          {crewmembers_brakes.map((member, index) => (
          <CrewCard
            key={index} // Ensure a unique key for each item
            name={member.name}
            image={member.image}
        ...
        <div className='technical'>
          ...
          <div className='technical-crew'>
          {crewmembers_sus.map((member, index) => (
          <CrewCard
            key={index} // Ensure a unique key for each item
            name={member.name}
            image={member.image}
